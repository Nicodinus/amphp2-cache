...
abstract class CacheTest extends AsyncTestCase
{
    ...
    public function testGetItem(): \Generator
    {
        ...
        $this->assertSame($testValue, $result->getResult());
        ...
        $this->assertInstanceOf(CacheItem::class, $result);
        $this->assertTrue($result->isIterable());
        $this->assertTrue($result->getIterator() instanceof Iterator);

        /** @var array $result */
        $result = yield toArray($result->getIterator());
